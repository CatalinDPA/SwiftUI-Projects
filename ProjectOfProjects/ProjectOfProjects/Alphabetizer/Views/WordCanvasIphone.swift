            ...
            HStack(spacing: Tile.spacing) {
                ForEach(tiles) { _ in
                    Rectangle()
                        ...
                        .offset(y: -(Tile.size + Tile.halfSize - 60))
...
extension WordCanvasIphone {
    private func setInitialTilePositions() {
        ...
        tiles.enumerated().forEach { index, tile in
            ...
            tiles[index].position.y = Tile.halfSize + 20
        }
    }
}
